  ...
  <body>
     ...
     <div class="container ">
        <div class="row">
            ...
            <h1 style="font-size:40px; font-weight:bold; text-align:center;" class=" mt-24">Update Breakfast Menu</h1>
                <form action="{{url('save_edit_breakfast',$data->id)}}" method="POST"  enctype="multipart/form-data">
                 @csrf
              ...
              <label for="floatingPassword">Discription</label>
               ...
               <p>Curent Image</p><br>
               <img width="100px" height="100px" src="/breakfastImg/{{$data->image}}" alt="">
              ...
              <label for="floatingPassword">Image</label>
               ...
               <div class="form-floating">
               <input type="submit" value="Update Breakfast Menu"  class="btn btn-success form-control" name="submit">
               </div>
