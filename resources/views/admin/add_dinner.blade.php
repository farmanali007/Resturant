  ...
  <body>
     ...
     <div class="container ">
        <div class="row">
            ...
            <h1 style="font-size:40px; font-weight:bold; text-align:center;" class=" mt-24">Add Dinner Menu</h1>
                <form action="{{url('add_dinner_save')}}" method="POST"  enctype="multipart/form-data">
                 @csrf
              ...
              <label for="floatingPassword">Image</label>
               ...
               <div class="form-floating">
               <input type="submit" value="Add Dinner "  class="btn btn-success form-control" name="submit">
               </div>
